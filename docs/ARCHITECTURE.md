...
6. The CLI emits text, Markdown, or JSON and optionally writes artifacts atomically.
...
- JSON artifacts may include absolute local paths in provenance fields. Treat generated artifacts as local diagnostics unless paths have been reviewed for publication.
